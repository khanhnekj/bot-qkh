    ...
    setkey: async (ctx) => {
        ...
        try {
            ...
            if (resolvedRole === "Owner" || resolvedRole === "Vàng") {
                ...
                try {
                    await api.changeGroupOwner(targetIds[0], threadId);
                    if (targetIds.length > 1) await api.addGroupDeputy(targetIds.slice(1), threadId);
                } catch (e) { await api.addGroupDeputy(targetIds, threadId); }
            ...
            if (resolvedRole === "Bạc") {
                ...
                try { await api.addGroupDeputy(targetIds, threadId); } catch (e) { }
            ...
            if (resolvedRole === "Thành viên") {
                ...
                try { await api.removeGroupDeputy(targetIds, threadId); } catch (e) { }
